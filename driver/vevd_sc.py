...
if __name__ == '__main__':
  ...
  m = model.vevd_sc.Model(model_cfg)

  if opts.is_train:
    trntst = model.vevd_sc.TrnTst(model_cfg, path_cfg, [0])
    ...
    model_cfg.subcfgs[model.vevd_sc.DEC].beam_width = opts.beam_width
