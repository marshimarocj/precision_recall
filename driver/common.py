...
def gen_caption_dir_struct_info(path_cfg, path_cfg_file):
...
def gen_img_dir_struct_info(path_cfg, path_cfg_file):
  path_cfg.load(path_cfg_file)
  ...
  path_cfg.trn_lst_file = os.path.join(split_dir, 'trn_names.npy')
  path_cfg.val_lst_file = os.path.join(split_dir, 'val_names.npy')
