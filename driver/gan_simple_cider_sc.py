...
if __name__ == '__main__':
  ...
  m = model.gan_simple_cider_sc.Model(model_cfg)

  if opts.is_train:
    trntst = model.gan_simple_cider_sc.TrnTst(model_cfg, path_cfg, [0])
    ...
    model_cfg.subcfgs[model.gan_simple_cider_sc.DEC].beam_width = opts.beam_width
