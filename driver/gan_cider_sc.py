...
if __name__ == '__main__':
  ...
  m = model.gan_cider_sc.Model(model_cfg)

  if opts.is_train:
    trntst = model.gan_cider_sc.TrnTst(model_cfg, path_cfg, [0])
    trn_reader = model.data.TrnGanReader(path_cfg.trn_ftfile, path_cfg.trn_videoid_file, path_cfg.trn_annotation_file)
    ...
    model_cfg.subcfgs[model.gan_cider_sc.DEC].beam_width = opts.beam_width
